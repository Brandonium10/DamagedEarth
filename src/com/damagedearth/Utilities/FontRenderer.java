...
public class FontRenderer
{
    ...
    public void drawString(String msg, int xCoord, int yCoord, float red, float green, float blue)
    {
        ...
        GL11.glTranslatef(xCoord, yCoord, -2.0f);   // Move One Unit Into The Screen

        GL11.glColor3f(red, green, blue);
        //GL11.glColor4f(red, green, blue, alpha);

        glPrint(msg);     // Print GL Text To The Screen
 ...
 *
 */
    private void buildFontNew(String fontName)
    {                          // Build Our Bitmap Font
        ...
        int bitmapSize = 512;                           // set the size for the bitmap texture 512
        ...
        GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA8, fontImage.getWidth(), fontImage.getHeight(), 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, scratch);
